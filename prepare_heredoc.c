...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/29 16:22:05 by eturbat           #+#    #+#             */
/*   Updated: 2022/10/30 11:53:55 by eturbat          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	exit_sigint(int fd, char *line, t_mini *data)
{
	free(line);
	line = NULL;
	rl_clear_history();
...
void	show_heredoc(t_mini *data, char *end, int do_eval, int fd)
{
	char	*line;
	char	*eval_line;
...
void	exec_heredoc(t_mini *data, char *end, bool do_eval, int fd)
{
	int					child;
